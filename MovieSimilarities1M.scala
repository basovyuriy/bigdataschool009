package com.hellosoftware.spark
...
// aws s3 cp s3://hello-spark/MovieSimilarities1M.jar ./
// aws s3 cp s3://hello-spark/ml-1m/movies.dat ./
...
object MovieSimilarities1M {
  ...
  def main(args: Array[String]) {
    ...
    val data = sc.textFile("s3n://hello-spark/ml-1m/ratings.dat")
